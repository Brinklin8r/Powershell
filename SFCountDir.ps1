...
$uncFullPath = "$uncServer\S_WebDocs\schoolsfirst"
...
$settingXML = $instLoc + "\SFCountDir.XML"
#		XML Settings file.
...
$logpath = "e:\BIN\SFCountlog" + $logingDate + ".txt"
Start-Transcript -Path $logpath -Append -Verbose
#	Cheap Logging!
Write-Host "Starting SFCountDir.PS1"
